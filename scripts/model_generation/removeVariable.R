...
r <- as.numeric(args[1])
removeVars <- colnames(filteredDescr)[r]
...
for(reps in 1:5){
  ...
  save(modelList,confusionMatrixList, file=paste0("data/gbm_models_removeVar_",as.numeric(args[1]),".RData"))
  
}
save.image(file=paste0("data/gbm_models_removeVar_",as.numeric(args[1]),".RData"))
